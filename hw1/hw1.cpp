...
int main(int argc, char **argv){
    ...
    std::cout << "Mem usage after reading:\n" << shell_get_command_output("free") << "\n";
    ...
    std::cout << "Mem usage after scrub:\n" << shell_get_command_output("free") << "\n";
    // write noise to disk and clear the memory
    std::cout << "Mem usage before launch write noise:\n" << shell_get_command_output("free") << "\n";
    char* wbuf;
    ...
    std::cout << "Mem usage almost finish write noise:\n" << shell_get_command_output("free") << "\n";
    if (wbuf) {
        delete[] wbuf;
    }
    invalid_res.clear();
    ...
    std::cout << "Mem usage before lauch writing signal:\n" << shell_get_command_output("free") << "\n";
    ...
    std::cout << "Mem usage almost finish writing signal:\n" << shell_get_command_output("free") << "\n";
    if (wbuf) {
        delete[] wbuf;
    }
    valid_res.clear();
    std::cout << "Mem usage after writing:\n" << shell_get_command_output("free") << "\n";
    // write log to disk
